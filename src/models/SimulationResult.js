import { ASSET_TYPES, EDU_PATTERNS } from "../constants/appData";
...
export const makeDefault = () => ({
  ...
  incomes: [
    { id: "inc1", label: "本業（会社員）", type: "employee", amount: 6_000_000, active: true },
  ],
  socialInsurance: 0,
  dependents: 1,
  spouseIncome: 0,
  ...
  cashCurrencies: [
    { currency: "JPY", ratio: 70 },
    { currency: "USD", ratio: 20 },
...
//models/defaultState.jsのコピペだがmakeDefault の型定義 → models/SimulationState.js に分離（任意）
//後で Redux/Zustand に移すときに便利。